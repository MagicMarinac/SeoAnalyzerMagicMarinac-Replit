        ...
        <div className="relative flex items-center justify-center lg:justify-end">
          ...
          >
            <g filter="url(#filter0_d_374_821)">
              ...
              <text fill="#6A7282" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="12.5926" fontWeight="500" letterSpacing="-0.02em"><tspan x="141.321" y="101.533">Optimizacija za umjetnu inteligenciju</tspan></text>
              <text fill="#7F22FE" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="22.6667" fontWeight="bold" letterSpacing="-0.02em"><tspan x="141.321" y="127.863">AIO/AEO/GEO</tspan></text>
            </g>
            <g filter="url(#filter1_d_374_821)">
              ...
              <text fill="#6A7282" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="12.5926" fontWeight="500" letterSpacing="-0.02em"><tspan x="224.629" y="308.533">Temeljna optimizacija web stranice</tspan></text>
              <text fill="#155DFC" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="22.6667" fontWeight="bold" letterSpacing="-0.02em"><tspan x="224.629" y="334.862">SEO optimizacija</tspan></text>
            </g>
            <g filter="url(#filter3_d_374_821)">
              ...
              <text fill="#6A7282" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="12.5926" fontWeight="500" letterSpacing="-0.02em"><tspan x="316.629" y="204.533">Pro izvještaj sa popravcima i rješenjima</tspan></text>
              <text fill="#009966" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="22.6667" fontWeight="bold" letterSpacing="-0.02em"><tspan x="316.629" y="230.862">Pro rješenja</tspan></text>
            </g>
